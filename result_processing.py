...
def statistic_analysis(scores, metric_index):
    ...
    save_table(metric_key + '_advantage.tex',
               tabulate(advantage_table, headers, tablefmt='latex'))
    ...
    save_table(metric_key + '_significance.tex',
               tabulate(significance_table, headers, tablefmt='latex'))
    ...
    save_table(metric_key + '_stat_better.tex',
               tabulate(stat_better_table, headers, tablefmt='latex'))
